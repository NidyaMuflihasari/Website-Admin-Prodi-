...
@section('content')
<a href="/tambah-akademik/create"class="btn btn-primary btn-sm">Tambah</a>
<a href="/data-kategoriakademik"class="btn btn-primary float-right btn-sm">Kategori Akademik</a><br><br>
